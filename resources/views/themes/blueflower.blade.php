            ...
            <div class="container">
                <div class="row ">
                    <div class="col-md-8 offset-md-2 col-sm-12 col-12 d-flex mb-4 mt-5">
                        <img src="{{'/foto_pengantin/'. $weddings->image }}" class=" mx-auto  mt-5" alt="100x100" style="width: 280px;height: 280px;border-radius: 147px;">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 offset-md-2 d-flex text-center"></div>
                    <h1 class="text-center mb-2" style="font-family: Satisfy, Arial, serif;color:#ECB390;font-weight: normal;font-size:48px;">{{$weddings->name_bride}} & {{$weddings->name_groom}}</h1>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2 mt-md-4 float-heading">
                            <img src="{{'/foto_pengantin/'. $weddings->image }}" class=" mx-auto d-block  mt-5" alt="100x100" style="width: 191px;height: 191px;border-radius: 100px;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 offset-md-2 d-flex text-center"></div>
                        <h1 class="text-center mb-3 mt-md-3">{{$weddings->name_bride}} & {{$weddings->name_groom}}</h1>
                ...
                <div class="container" >
                    ...
                    <div class="couple-wrap" data-scroll="" data-scroll-direction="vertical" data-scroll-delay="0.18" data-scroll-speed="6">
                        <div class="couple-half"  >
                            <div class="groom">
                                <img src="{{'/foto_pengantin/'. $weddings->photo_groom }}" alt="" class="img-fluid d-block mx-auto">
                            </div>
                            <div class="desc-groom">
                                <h3>{{$weddings->name_groom}}</h3>
                                <p><span style="color: #bf9b73">Putra {{$weddings->child_groom}} dari</span><br>
                                    <span class="parents-font">Bapak {{$weddings->father_groom}}</span>
                                    <br>
                                    <span class="parents-font">Ibu {{$weddings->mother_groom}}</span>
                                </p>
                            </div>
                        </div>
                        <div class="couple-half " >
                            <div class="bride">
                                <img src="{{'/foto_pengantin/'. $weddings->photo_bride }}" alt="" class="img-fluid d-block mx-auto">
                            </div>
                    ...
                    <div class="row row-bottom-padded-md animate-box">
                        <div class="col-md-12">
                            <div id="carouselExampleInterval" class="carousel carousel-dark slide " data-bs-ride="carousel" >
                                ...
                                @php $i = 1; @endphp
                                    @foreach ($gallery as $multiupload)
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="greet" method="post">
                                            @csrf
                                            <div class="mb-3">
                                                <input type="text" class="form-control"  name="name_url" value="{{$weddings->name_url}}" hidden/>
                                            </div>
                                            <div class="mb-3">
            ...
            <div class="container">
                <div class="row">
                   <div class="col-md-8 offset-md-2 mt-2 mx-auto d-block">
                        ...
                        <img src="{{'/foto_pengantin/'. $weddings->image }}" class=" mx-auto d-block  mt-5" alt="100x100" style="width: 191px;height: 191px;border-radius: 100px;">
                        <h1 class="text-center mb-3 mt-md-3">{{ $weddings->name_groom }} & {{ $weddings->name_bride }}</h1>
                    </div>
                </div>
            </div>
            </div>
